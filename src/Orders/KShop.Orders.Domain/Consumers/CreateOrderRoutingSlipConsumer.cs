...
namespace KShop.Orders.Domain.Consumers
{
        ...
        IConsumer<RoutingSlipFaulted>
    {
        ...
        {
            var createActivity = _formatter.ExecuteActivity<OrderCreate_RoutingSlipActivity, OrderCreate_RoutingSlipActivity_Args>();
            ...
            builder.AddActivity(nameof(OrderCreate_RoutingSlipActivity), new Uri($"exchange:{createActivity}"),
                new OrderCreate_RoutingSlipActivity_Args
                {
                });
