        ...
        <div key={props.id} className="kshop-product-card">
            <div className="kshop-product-card-image">
                <span className="kshop-product-card-fav">
                    <FontAwesomeIcon
                        onClick={() => toast(`LIKE ${props.id}`, { autoClose: 2000 })}
                        icon={faHeartBroken}
                    />
                </span>
                <Link to={productLink}>
            ...
            <div className="kshop-product-card-actions">
                <button className="kshop-button-green" onClick={()=>{toast(`В корзину ${props.id}`)}}>
                ...
                >
                    <a href="#" onClick={()=>{toast("Action 1")}}>Action 1</a>
                    <a href="#" onClick={()=>{toast("Action 2")}}>Action 2</a>
                    <a href="#" onClick={()=>{toast("Action 3")}}>Action 3</a>
                </DropDown>
            </div>
        </div>
    );
